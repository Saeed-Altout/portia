...
import { SummaryCard } from "@/components/root/cards/summary-card";
    ...
    <Section>
      <Container className="gap-y-12 max-w-[800px]">
        <p className="text !text-lg">
          Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec ullamcorper mattis lorem non. Ultrices praesent
          amet ipsum justo massa. Eu dolor aliquet risus gravida nunc at feugiat consequat purus. Non massa enim vitae
        ...
        <div className="space-y-6">
          ...
          <p className="text !text-lg">
            ...
            arcu amet, vitae nisi, tellus tincidunt. At feugiat sapien varius id. Eget quis mi enim, leo lacinia
            pharetra, semper. Eget in volutpat mollis at volutpat lectus velit, sed auctor. Porttitor fames arcu quis
            fusce augue enim. Quis at habitant diam at. Suscipit tristique risus, at donec. In turpis vel et quam
        ...
        <p className="text !text-lg">
          ...
          consectetur turpis. Sapien, dictum molestie sem tempor. Diam elit, orci, tincidunt aenean tempus. Quis velit
        ...
        <div className="space-y-6">
          ...
          <p className="text !text-lg">
            ...
            Pulvinar ullamcorper sit dictumst ut eget a, elementum eu. Maecenas est morbi mattis id in ac pellentesque
            ac.
          </p>
        </div>
        ...
        <div className="space-y-6">
          ...
          <ol className="space-y-2" style={{ listStyle: "inside" }}>
            ...
            <li className="font-normal leading-6 text-gray-500 text-lg">
              Eu turpis <span className="underline cursor-pointer">posuere semper feugiat</span> volutpat elit, ultrices
              suspendisse. Auctor vel in vitae placerat.
            </li>
            <li className="font-normal leading-6 text-gray-500 text-lg">
              Suspendisse maecenas ac <span className="underline cursor-pointer">donec scelerisque</span> diam sed est
              duis purus.
            </li>
          </ol>
        </div>
        ...
        >
          <p className="text !text-lg">
            ...
            Duis est sit sed leo nisl, blandit elit sagittis. Quisque tristique consequat quam sed. Nisl at scelerisque
            ...
            pharetra odio consequat scelerisque et, nunc tortor.
            <LineSeparator />
