		...
		<Section>
			<Container size='wide' className='gap-y-8 md:gap-y-10 lg:gap-y-12'>
				...
				<Paragraph className='max-w-[640px] capitalize leading-8' size='xl'>
					Get ultra-stable mobile proxies with unlimited data and effortless country switching ⎯⎯ perfectly tailored
					for developers, social media managers, E-commerce, and digital marketing professionals.
				</Paragraph>
