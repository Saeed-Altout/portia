...
import { SettingsSchema, settingsSchema, initialValues } from '@/app/dashboard/schemas';
...
export default function SettingsPage() {
	...
	return (
		<Form {...form}>
			<form onSubmit={form.handleSubmit(onSubmit)} className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6'>
				...
				<div className='space-y-6 col-span-1 lg:col-span-2'>
					<div className='space-y-2'>
						...
						<p className='text-sm text-gray-500'>
							Share this link to with your friends and network to start receiving commission
						</p>
					</div>
					<Separator />
					<CustomField
					...
					<div className='space-y-6 pt-12'>
						<div className='space-y-2'>
							...
							<p className='text-sm text-gray-500 max-w-[551px]'>
								you can easily export all your data by clicking the button below your data will include all
								your proxies all your deposits
							</p>
						</div>
