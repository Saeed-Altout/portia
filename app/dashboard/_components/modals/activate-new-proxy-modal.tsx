...
import { ActivateNewProxySchema, activateNewProxySchema, initialValuesActivateNewProxy } from '@dashboard/schemas';
			...
			<Form {...form}>
				<form onSubmit={form.handleSubmit(onSubmit)} className='space-y-8'>
					...
					<div className='flex flex-col items-center gap-4'>
						...
						{step !== 1 && (
							<Button type='button' variant='outline' className='w-full' onClick={() => handleMove('prev')}>
								Pervious
							</Button>
						)}
						{step == 1 && (
	...
	return (
		<>
			<CustomField
				...
				isLoading={isLoading}
			/>
			<CustomField name='autoRenew' labelCheckbox='Auto Renew' type={FiledType.CHECKBOX} isLoading={isLoading} />
			<CustomField
				name='username'
				...
				isLoading={isLoading}
			/>
			<CustomField name='password' placeholder='Password' icon={Key} type={FiledType.TEXT} isLoading={isLoading} />
