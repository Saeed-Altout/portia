...
import { AvatarBox } from "@/components/root/ui/avatar-box";
import { Skeleton } from "@/components/ui/skeleton";

export const TestimonialCard = ({ initialData }: { initialData: Review }) => {
  const { user_image, user_name, specialization, message, rating } = initialData;
  ...
  return (
    <div className="space-y-12">
      ...
      <AvatarBox name={user_name || "unknown"} position={specialization} imgUrl={user_image} />
    </div>
  );
};
