...
const CarouselPrevious = React.forwardRef<HTMLButtonElement, React.ComponentProps<typeof Button>>(({ className, variant = 'outline', size = 'icon', ...props }, ref) => {
	...
	return (
		<Button ref={ref} variant={variant} size={size} className={cn('h-14 w-14 rounded-full', className)} disabled={!canScrollPrev} onClick={scrollPrev} {...props}>
...
const CarouselNext = React.forwardRef<HTMLButtonElement, React.ComponentProps<typeof Button>>(({ className, variant = 'outline', size = 'icon', ...props }, ref) => {
	...
	return (
		<Button ref={ref} variant={variant} size={size} className={cn('h-14 w-14 rounded-full', className)} disabled={!canScrollNext} onClick={scrollNext} {...props}>
