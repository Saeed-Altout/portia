...
export class CookieStorage {
  ...
  public setEmail(email: string, options: CookieOptions = {}): this {
    return this.setCookie("email", email, options);
  }

  public getEmail(): string | null {
    return this.getCookie<string>("email");
  }

  public removeEmail(): this {
    return this.removeCookie("email");
  }
